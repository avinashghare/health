<div id="page-title">
    <a href="<?php echo site_url("site/viewclinic"); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
...
Create clinic </h3>
                ...
                <div class="panel-body">
                    <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createclinicsubmit");?>' enctype='multipart/form-data'>
                        <div class="panel-body">
                            ...
                            <div class=" form-group">
                              ...
                              <div class="col-sm-4">
                                <?php
                                    ...
                                    echo form_dropdown('typeofclinic[]',$typeofclinic,set_value('typeofclinic'),'id="select3" class="chzn-select form-control" 	data-placeholder="Choose an typeofclinic..." multiple');
                                ?>
                              </div>
                            </div>
                            <div class=" form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <a href="<?php echo site_url("site/viewclinic"); ?>" class="btn btn-secondary">Cancel</a>
                                </div>
                            </div>
                    </form>
                    </div>
