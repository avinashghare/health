<section class="panel">
    ...
    <div class="panel-body">
        <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editclinicsubmit");?>' enctype='multipart/form-data'>
            ...
            <div class=" form-group">
                              ...
                              <div class="col-sm-4">
                                <?php
                                    ...
                                    echo form_dropdown('typeofclinic[]',$typeofclinic,set_value('typeofclinic',$selectedtypeofclinic),'id="select3" class="chzn-select form-control" 	data-placeholder="Choose an typeofclinic..." multiple');
                                ?>
                              </div>
                            </div>
            <div class=" form-group">
