...
<div id="page-content">
    ...
    <script>
        function drawtable(resultrow) {
            return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.doctor + "</td><td>" + resultrow.clinic + "</td><td>" + resultrow.price + "</td><td><a class='btn btn-primary btn-xs' href='<?php echo site_url('site/editdoctorclinic?id=');?>" + resultrow.clinic + "&doctorclinicid="+resultrow.id+"'><i class='icon-pencil'></i></a><a class='btn btn-danger btn-xs' onclick=return confirm(\"Are you sure you want to delete?\") href='<?php echo site_url('site/deletedoctorclinic?id='); ?>" + resultrow.clinic + "&doctorclinicid="+resultrow.id+"'><i class='icon-trash '></i></a></td></tr>";
        }
